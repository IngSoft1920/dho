...
public class PasarPedidos {
	...
	/*Por lo que tiendo, el metodo debería recibir la lista de pedidos ya conformada, 
	 * los campos que tienen que venir rellenados en cada uno de estos pedidos es: 
	 * -producto_id, -cantidad,-fecha,-lugar,-especificaciones
	 * Y el id_hotel que va a relaizar estos pedidos
	 */
	
	public static void  pasarPedidos( int hotel_id ,LocalDate fecha,String lugar, int [] productos_id,
			int[] cantidades, String[] especificaciones) {
		
			
			if (lugar.equals("restaurante")) {
				pasarPedidosaFnb(hotel_id ,fecha, productos_id,
	...
	public static void pasarPedidosaFnb( int hotel_id ,LocalDate fecha, int[] productos,int[] cantidades,
			String[] especificaciones) {
